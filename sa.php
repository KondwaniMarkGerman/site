...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_btn-link&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Nov 2017 14:39:24 GMT -->
<head>
  ...
  <div class="w3-modal-content">
    <div class="w3-display-container">
      ...
      <div id="preSave" class="w3-panel">
        ...
        <p><a href="../default.html" onclick="event.preventDefault();displayError()">Report Error</a></p>
  ...
  <div class="w3-modal-content">
    <div class="w3-display-container">
      ...
      <div id="driveText" class="w3-panel w3-large">
        ...
        <input class="w3-input w3-border" type="text" id="googleFileName" value="trybs_ref_btn-link">
...
<span onclick="openMenu()" class="w3-button w3-display-topright w3-transparent" style="font-weight:bold;">&times;</span>
  ...
  <a style="display:inline;padding:0;" href="../about/about_copyright.html" target="_blank" onclick="openMenu();" class="w3-hover-none w3-hover-text-green">Copyright 1999-2017</a></p>
  </footer>
</div>
...
function saveFile(code) {
    ...
    if(httpB.readyState == 4 && httpB.status == 200) {
        if(httpB.responseText.substr(0,2) == "OK" ) {
          ...
          document.getElementById("shareLink").href = "../code/tryit1b9e.asp?filename=" + getId;
          document.getElementById("shareLinkText").innerHTML = "../code/tryit1b9e.asp?filename=" + getId;
